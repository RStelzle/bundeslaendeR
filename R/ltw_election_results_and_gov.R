#' Election Results of Landtagswahlen in the German states (Bundeslaender) since 1946 as well as government constellation.
#'
...
#'   \item{gov_end_date}{int End date of the government.}
#'   \item{gov_party}{lgl Boolean wether the party was a cabinet party.}
