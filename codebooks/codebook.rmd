...
Example code joining Appeldorn and Fortunato's legislative capacity data *in election years* -where available- to `ltw_elections_meta` in `R`:
...
ltw_elections_meta %>% 
  ...
  left_join(
    ...
    by = c(
      ...
      "state_name_en_appeldorn_fortunato" = "land"
    )
  )
