...
short_item(item_name_code = "election_id_\nbundeswahlleiter",
           ...
           item_desc = "Specific election\\_id as denoted by the Bundeswahlleiter.
...
```{r, results="asis"}
short_item(item_name_code = "wzb_govelec_id",
...
```{r, results="asis"}
short_item(item_name_code = "ches_id",
           item_name = "CHES ID",
...
```{r, results="asis"}
short_item(item_name_code = "partyfacts_id",
...
```{r, results="asis"}
short_item(item_name_code = "decker_neu",
