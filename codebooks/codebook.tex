...
\texttt{link\_coalitionagreements} and \texttt{link\_positions\_pwib}
\texttt{bundeslaendeR} data can be linked to other datasets.
...
\begin{longtable}{p{3.2cm}| p{11cm}}
\texttt{party\_pwib in link\_positions\_pwib} &\textbf{Party name in PWIB Data.}\newline 
