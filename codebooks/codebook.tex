...
\texttt{ltw\_combined} dataset. For further variables plese refer to the
\texttt{ltw\_elections} dataset's codebook.
...
easy links of \texttt{ltw\_elections} or \texttt{ltw\_combined} with
party manifestos and coalition agreements made available from
polidoc.net - The Political Documents Archive
