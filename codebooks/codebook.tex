...
\ofoot*{30.06.2022} \ihead{\headmark}
...
the tibble package is loaded) containing meta information on election
results. Each row contains information on one election.
